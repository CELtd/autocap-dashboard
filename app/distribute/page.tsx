...
import { Loader2, AlertTriangle, CheckCircle, ExternalLink, FlaskConical } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        {isSuccess && txHash && (
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 mb-6">
            ...
            <p className="text-sm text-green-600 dark:text-green-400 mb-2">Transaction Hash:</p>
            <a
        ...
        {distributionData && !isSuccess && (
          <>
            {/* Test Mode Warnings */}
            {(distributionData.testMode || distributionData.testRecipientOverride || distributionData.testInjectExtraWinner) && (
              <div className="mb-6 p-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    {distributionData.testRecipientOverride && distributionData.testRecipientAddress && (
                      <p className="text-sm text-purple-700 dark:text-purple-300">
                        <strong>Recipient Override:</strong> All DataCap will be sent to test address:
                        <br />
                        <code className="font-mono text-xs bg-purple-100 dark:bg-purple-900/50 px-1 py-0.5 rounded">
                          {distributionData.testRecipientAddress}
                        </code>
                      </p>
                    )}
                    ...
                    >
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-mono text-gray-700 dark:text-gray-300">
                            {truncateAddress(tx.meta.recipientAddress, 6)}
                          </span>
                        </div>
                        <div className="flex justify-between">
              ...
              {!isConnected ? (
                <div className="text-center">
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Connect your wallet to execute the distribution. You must be a Safe owner.
                  </p>
                  <ConnectButton />
                </div>
              ) : distributionData.transactions.length === 0 ? (
